          ...
          {result ? (
              ...
              <div className="p-6 space-y-6 flex-1 overflow-y-auto">
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  <p className="text-sm text-slate-600 italic text-center">
                    Want to have another go to build your confidence by practicing your calculation skills with another client? Click on the button below.
                  </p>
                </div>
              </div>
            ...
            <div className="h-full flex items-center justify-center bg-slate-50 rounded-xl border border-dashed border-slate-300 p-8 text-center text-slate-400">
              <div>
                ...
                <p>Submit your calculation to see<br/>detailed feedback and analysis.</p>
              </div>
            </div>
          )}
        </div>
