    ...
    <div className={`animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col ${isFullscreen ? 'h-full' : ''}`}>
      {!isFullscreen && (
        <div className="text-center max-w-3xl mx-auto mb-6 flex-shrink-0 space-y-2">
          <h1 className="text-3xl font-bold text-slate-900">Interactive Lesson</h1>
          <p className="text-lg text-slate-600">
            Review the core concepts of body composition before starting the activities.
          </p>
        </div>
      )}
      ...
      >
        ...
        >
            ...
            <iframe 
                src="https://gamma.app/embed/khlvujb66fl8cae" 
                style={{ 
                    width: '100%', 
                    height: '100%', 
