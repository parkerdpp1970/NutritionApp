    ...
    <div className={`animate-in fade-in slide-in-from-bottom-4 duration-500 flex flex-col ${isFullscreen ? 'h-full' : ''}`}>
      {!isFullscreen && (
        <div className="text-center max-w-3xl mx-auto mb-6 flex-shrink-0 space-y-2">
          <h1 className="text-3xl font-bold text-slate-900">Interactive Lesson: Energy Needs</h1>
          <p className="text-lg text-slate-600">
            Review the core concepts of energy expenditure and calculation methods before starting the activities.
          </p>
        </div>
      )}
      ...
      >
        ...
        >
            ...
            <iframe 
                src="https://calculating-energy-needs-wksact2.gamma.site/" 
                style={{ 
                    width: '100%', 
                    height: '100%', 
                ...
                allow="fullscreen" 
                title="Calculating Energy Needs Lesson"
            ></iframe>
        </div>
      </div>
    </div>
